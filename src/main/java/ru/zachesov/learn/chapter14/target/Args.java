...
import static ru.zachesov.learn.chapter14.target.ArgsException.ErrorCode.*;
...
public class Args {
  ...
  private void parseSchema(String schema) throws ArgsException {
    for (String element : schema.split(","))
      if (!element.isEmpty()) parseSchemaElement(element.trim());
  }
  ...
  private void parseSchemaElement(String element) throws ArgsException {
    ...
    if (elementTail.isEmpty()) marshalers.put(elementId, new BooleanArgumentMarshaler());
